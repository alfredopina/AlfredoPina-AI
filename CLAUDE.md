...
- **Pendiente para la siguiente sesión:** publicar el curso `excel-bi` desde el admin (corrigiendo de paso el nombre "Basico-Intermedio" sin acento) para que aparezca en `recursos.html`, y probar el resto de tipos de recurso (Casos, Plantillas, Contenido Complementario) y el reordenamiento por drag & drop
