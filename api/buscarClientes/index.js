...
// por nombre o código. NUNCA regresa Prospectos (es pública — quién estás
// cotizando no debe ser enumerable); los pickers del admin que sí los
// necesitan usan buscarClientesAdmin. Nació protegida (rol "admin") para el formulario de
...
module.exports = async function (context, req) {
  ...
  try {
    ...
    const result = await pool
      ...
      .query("SELECT TOP 20 id, nombre, codigo FROM Cliente WHERE tipo_cliente <> 'Prospecto' AND (nombre LIKE @q OR codigo LIKE @q) ORDER BY nombre");
