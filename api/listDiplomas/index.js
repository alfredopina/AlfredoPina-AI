...
module.exports = async function (context) {
  try {
    ...
    const result = await pool.request().query(`
      SELECT g.id AS grupo_id, cli.nombre AS cliente, cli.codigo AS cliente_codigo, clf.nombre AS cliente_final, clf.codigo AS cliente_final_codigo,
      ...
      GROUP BY g.id, cli.nombre, cli.codigo, clf.nombre, clf.codigo, g.nombre_curso, g.herramientas, g.instructor, g.modalidad, g.fecha_inicio, g.fecha_fin, g.horas, g.diploma_token
